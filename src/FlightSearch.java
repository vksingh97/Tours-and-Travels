	    ...
	    throws IOException, ServletException
	    {
	       ...
	       System.out.println(type);
	        ...
	        String query =null;
	   		try{
	   			getServletContext().getRequestDispatcher("/Pages/Common/Global.jsp").include(request,response);
	   	     	...
	   	     	PreparedStatement st=conn.prepareStatement("select * from flights  where source=? and destination = ?");
	            int reqno=0;
	        //    query = new String("select * from flightbooking"); 
	            ...
	            out.println("<tr><td align=right> Flightno </td><td align=right> Date </td><td> Flight Name </td><td align=right> Time </td><td> Economy Fare </td><td> Economy Discounted Fare </td><td> First Class Fare </td><td> First Class Discounted Fare </td><td> Business Class Fare </td><td> Business Class Discounted Fare </td></tr>");
	            ...
	            while(rs.next())
	            {
	            	...
	            	{	double i = (rs.getInt(5)*2);
	            		...
	            		String s= rs.getString(1);
            			out.println("<tr><td align=left>"+rs.getString(1)+"</td><td align=left>"+rs.getString(7)+"</td><td align=left>"+rs.getString(2)+"</td><td align=left>"+rs.getString(6)+"</td><td align=left>"+i+"</td><td align=left>"+j+"</td><td align=left>"+i*1.5+"</td><td align=left>"+j*1.5+"</td><td align=left>"+i*2+"</td><td align=left>"+j*2+"</td><td><a href='Pages/Travelling/FlightBooking.jsp?Flightno="+s+"&s="+rs.getString(3)+"&d="+rs.getString(4)+"&type="+type+"'<img src=''>Book</a></td></tr>");		
